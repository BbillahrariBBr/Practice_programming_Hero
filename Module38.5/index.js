/*
tasks
1.some middle console log will be after 3.5 seconds
2. take a number form users, using prompt and add 250 to that number
and  display that number using alert
3. what is cookies, writing in english at least 5-7 lines
4. write at least 3 differences between local storage and session storage
5. differences between cookies, localStorage and session storage
6. what is event loop in js
how synchronous and asynchronous code work in js
7. tell me 4 things that are asynchronous in js
8.clear your local storage
9. set a local item.key.name value sakib khan
